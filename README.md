...
A high-performance, modular NLP suite designed for high-accuracy FAQ retrieval across multiple domains (Medical, Legal, Finance, Tech, Education). The system utilizes a hybrid scoring mechanism combining Transformer-based semantics, lexical statistics & linguistic structure (POS/NER).
